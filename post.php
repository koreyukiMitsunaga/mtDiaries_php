...
?>
	<main>
		<div class="innerForm">
			<form method="post" name="post" action="postResult.php" enctype="multipart/form-data">
				<label >
				...
				<label>
					<div class="post_rel">
						...
						<p><img id="preview" class="mg-t10"></p>
					</div>
				</label>
				<label>
				...
				<label>
					...
					<input type="text" name="time" value="<?php echo $time;?>" id="postTime" class="formBox wt200">
				</label>
				<label>
				...
				<div class="mg-t10 al_right">
					<!--<input type="submit" name="draft" value="下書き" class="postSubmit btn glay opa">-->
					<input type="submit" name="post" value="投稿" class="postSubmit btn blue opa">
				</div>
