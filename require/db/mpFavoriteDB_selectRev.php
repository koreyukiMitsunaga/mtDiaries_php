...
$sql = "select * from post join user on post.user_id = user.user_id join mountain on post.mountain = mountain.mountain join favorite on post.post_id = favorite.post_id where favorite.user_id = '$session_user_id' order by post.post_id desc";
